...
const Update = () => {
  ...
  const handleUpdateNowBtn = (e) => {
    ...
    fetch(
      `https://my-assignment-10-server-two.vercel.app/updatedata/${updateData[0]?._id}`,
      {
        method: "PUT",
        headers: {
  ...
  return (
    <div className="w-10/12 my-28 mx-auto flex justify-center item-center flex-col h-screen">
      <div className="text-center font-roboto text-[#B70050]">
        <p className="font-semibold py-5 text-2xl">Update You Craft Item</p>
      </div>
      {updateData.map((dataUpdate) => (
        <div key={dataUpdate._id}>
          <form
            onSubmit={handleUpdateNowBtn}
            className="w-11/12 space-y-4 mx-auto "
          >
            <div>
              ...
              <input
                ...
                name="Item_Name"
                defaultValue={dataUpdate.Item_name}
                type="text"
              />
            </div>
            <div>
            ...
            <div>
              ...
              <input
                defaultValue={dataUpdate?.Short_Description}
                className="w-full px-3 py-2 outline-none border-2"
            ...
            <div>
              ...
              <input
                defaultValue={dataUpdate?.Procassing_Time}
                className="w-full px-3 py-2 outline-none border-2"
            ...
            <div className="flex gap-5">
              ...
              <div className="flex gap-2 items-center">
                ...
                <input
                  type="radio"
                  defaultChecked={dataUpdate.Customization === "yes"}
                  value={"yes"}
                  name="Customization"
                  id="yes"
                />
              ...
              <div className="flex gap-2 items-center">
                ...
                <input
                  type="radio"
                  defaultChecked={dataUpdate.Customization === "no"}
                  name="Customization"
                  id="no"
                  value={"no"}
                />
            ...
            <div className="flex gap-5">
              ...
              <div className="flex gap-2 items-center">
                ...
                <input
                  type="radio"
                  defaultChecked={dataUpdate.Stuck_status === "In stock"}
                  value={"In stock"}
                  name="Stuck_status"
                  id="in-stock"
                />
              ...
              <div className="flex gap-2 items-center">
                ...
                <input
                  required
                  type="radio"
                  defaultChecked={dataUpdate.Stuck_status === "Made to Order"}
                  name="Stuck_status"
                  id="no-stock"
                  value={"Made to Order"}
                />
            ...
            <div className="flex gap-5">
              ...
              <div className="flex gap-2 items-center">
                ...
                <input
                  defaultChecked={dataUpdate.Rating === "1"}
                  type="radio"
                  value={"1"}
                  name="Rating"
                  id="1"
              ...
              <div className="flex gap-2 items-center">
                ...
                <input
                  type="radio"
                  defaultChecked={dataUpdate.Rating === "2"}
                  value={"2"}
                  name="Rating"
                  id="2"
                />
              ...
              <div className="flex gap-2 items-center">
                ...
                <input
                  type="radio"
                  defaultChecked={dataUpdate.Rating === "3"}
                  value={"3"}
                  name="Rating"
                  id="3"
                />
              ...
              <div className="flex gap-2 items-center">
                ...
                <input
                  type="radio"
                  defaultChecked={dataUpdate.Rating === "4"}
                  value={"4"}
                  name="Rating"
                  id="4"
                />
              ...
              <div className="flex gap-2 items-center">
                ...
                <input
                  type="radio"
                  value={"5"}
                  defaultChecked={dataUpdate.Rating === "5"}
                  name="Rating"
                  id="5"
                />
              </div>
